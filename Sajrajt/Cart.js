...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadCart() {
        ...
        // Nejdřív zkusíme načíst z localStorage
        if (savedCart) {
            try {
                ...
                <div class="cart-item" data-id="${item.id}">
                    ...
                    <div class="item-details">
                        <div class="item-header">
                            <h3>${item.name}</h3>
                            <button class="remove-btn" aria-label="Odstranit položku" data-id="${item.id}">
                        ...
                        <div class="item-bottom">
                            <div class="quantity-control">
                                ...
                                <input type="number" class="quantity" value="${item.quantity}" min="1" max="99" data-id="${item.id}">
            ...
            const summaryItemHTML = `
                <div class="summary-item">
                    ...
                    <div class="summary-item-details">
                        ...
                        <span class="summary-item-variant">${item.variant} × ${item.quantity}</span>
                    </div>
    ...
    function updateItemPrice(id) {
        ...
        if (index !== -1) {
            ...
            if (summaryVariantElement) {
                summaryVariantElement.textContent = `${cart[index].variant} × ${cart[index].quantity}`;
            }
    ...
    function updatePrices() {
        ...
        if (shippingEl) shippingEl.textContent = shippingPrice === 0 ? 'Zdarma' : `${shippingPrice} Kč`;
        ...
        if (summaryShippingEl) summaryShippingEl.textContent = shippingPrice === 0 ? 'Zdarma' : `${shippingPrice} Kč`;
    ...
    function calculateTotal() {
        const subtotal = calculateSubtotal();
        return subtotal + shippingPrice + paymentFee - discountAmount;
    }
    ...
    function applyCoupon() {
        ...
        setTimeout(() => {
            ...
            if (discountEl) {
                ...
                discountEl.style.transition = 'color 0.3s ease';
            ...
            if (summaryDiscountEl) {
                summaryDiscountEl.style.color = 'var(--success)';
                summaryDiscountEl.style.transition = 'color 0.3s ease';
                
                setTimeout(() => {
                    summaryDiscountEl.style.color = '';
                }, 1500);
            }
        }, 800);
    }
